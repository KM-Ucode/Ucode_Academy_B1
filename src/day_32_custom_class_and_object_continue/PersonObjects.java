...
public class  PersonObjects {
    public static void main(String[] args) {
        ...
        String str = person1.firstName; // or we can print using String
        ...
        System.out.println(person3);// person3 is an object, when we try to print
                                   // we are going to get hash code. We have to use toString in Person class
