...
public class SetPractice {
    public static void main(String[] args) {
        ...
        Set<Character> chSet =  new TreeSet<>(Arrays.asList('b','d','c','a','e'));
        System.out.println(chSet);

        Set<Character> ch2 = new LinkedHashSet<>(Arrays.asList('b','d','c','a','e'));
        System.out.println(ch2);

        Set<Character> ch3 = new HashSet<>(Arrays.asList('b','d','c','a','e'));
