...
public class ScannerPractice4 {
    ...
    public static void main(String[] args) {
        ...
        // if the weather is nice, and you don't have any Java task go outside
        // else stay home and do your Java tasks
        // verify/ validate the user enters boolean. True for yes, false for no
        ...
        if (input.hasNextBoolean()){
            anyJavaTask = input.nextBoolean(); // it is not assigning the user input true/false
        ...
        if (isWeatherNice == true && anyJavaTask ==false){
