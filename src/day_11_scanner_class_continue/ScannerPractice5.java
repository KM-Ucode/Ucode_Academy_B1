...
public class ScannerPractice5 {
    ...
    public static void main(String[] args) {
        ...
        // Write a java program to take input from user yes or no (boolean - true/false)
        // if the weather is nice, and you don't have any Java task go outside and have fun
        // else stay home and do your Java tasks
        // verify/ validate the user enters yoe or no(boolean - true for yes, false for no)
        ...
        if (isWeatherNice && !anyJavaTask) {
            ...
            System.out.println("Stay home and do your task");
