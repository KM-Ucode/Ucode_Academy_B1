...
public class CollectionMethods3 {
    public static void main(String[] args) {
        ...
        ArrayList<String> strList = new ArrayList<>(Arrays.asList("wava", "testing","postman", "z", "selenium"));

        String str = Collections.max(strList);
        // For string, it does not return the longest string, it returns string that starts with the highest char
