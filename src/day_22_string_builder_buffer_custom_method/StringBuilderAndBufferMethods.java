...
public class StringBuilderAndBufferMethods {
    public static void main(String[] args) {
        ...
        strBuilder.insert(1,"A");  //inserting value/str/obj at the given index

        System.out.println(strBuilder);

        System.out.println("=============================");

        strBuilder.replace(0,3,"AAA"); //replace from to startIndex until the endIndex with new str
        System.out.println(strBuilder);
        ...
        String s = String.valueOf(1234);  //Convert/cast number to String /as string
