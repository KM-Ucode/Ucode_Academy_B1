...
public class MultiDimensionalArray {
    public static void main(String[] args) {
        ...
        int [][] arrayOfArrays = new int[3][4]; //Two-dimensional array that can hold
        // three arrays with length of 4 (each array)

        arrayOfArrays[0][0] = 1;
        arrayOfArrays[1][0] =10;
        arrayOfArrays[2][0] =55 ;

        System.out.println(arrayOfArrays[0][0]);

        System.out.println(arrayOfArrays[1][0]);
        ...
        System.out.println(twoDArray[0].length); // it returns the length of first array in two-d array
