...
public class CustomMethodReturnType2 {
    ...
    // This method takes  String as argument/parameter, and returns string in reverse
    ...
    // This method takes int array as argument/parameter, and return int array in reverse order
    ...
    public static int[] reverseIntArray(int[]arr){
        ...
        return result; // it returns and closes method
