...
public class StringCharAtMethod {
    ...
    public static void main(String[] args) {
        ...
        //                       0123 ect
        // example String str = "java" (every character has it own index)
        // charAt(); takes index/number and return char at given index

        // Task:
        // Create a string and use charAT(); method to get each char an assign to a char variable
        ...
        // Task:
        // Start from o and take every even index from String (word) and assign it to anew String
        // 02468101214
        ...
        // and assign to a new string initials
