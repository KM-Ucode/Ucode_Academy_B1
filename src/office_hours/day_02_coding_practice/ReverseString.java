...
public class ReverseString {
    public static void main(String[] args) {
        ...
        // "java" -> avaj
        // We can do it in the main method ,but it's always good to create a custom method,
    ...
    public static String reverseString1(String str){
        ...
        for (int i= str.length()-1; i >=0; i--){
            reversed += str.charAt(i); // it creates a new object in string pool. Nothing wrong with going this way
    ...
    public static String reverseString4(String str){
         ...
         return
                 str.charAt(str.length()-1)+reverseString4(str.substring(0, str.length()-1));
    }
