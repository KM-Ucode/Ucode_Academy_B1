...
public class ConstructorCalls {
    ...
    public ConstructorCalls(String name){
        this(33);
        //name = name; We need to use 'this' because parameter
        // variable and instance variable have the same name
        this.name = name;
    ...
    public static void main(String[] args) {
        ConstructorCalls obj = new ConstructorCalls(); // Default constructor gets executed/invoked
