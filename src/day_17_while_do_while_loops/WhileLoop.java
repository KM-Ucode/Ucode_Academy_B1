...
public class WhileLoop {
    public static void main(String[] args) {
        ...
        int i = 1; // initialization
                while (i <= 10){ // keep repeating the code inside the loop body while the condition is true
                    System.out.println(i);
        ...
        System.out.println(" Printing all numbers until evenly divisible by 3 and 5");
                int j = 16;
                // Task
